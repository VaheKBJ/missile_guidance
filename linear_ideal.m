classdef linear_ideal < PPN

methods 
    function obj = linear_ideal(deltaErrDeg, rng0)
        %
        ...
        obj.Xref    =	[obj.RmtRef0; LamRef; OmgRef; GamTRef; GamMRef];
...
%             Xspank = zeros(size(tspanode))';
            xode = obj.Xk; 
            [~, Xspank] =	ode45(@(tt, xx) linear_ideal.dX(tt, xx, obj), tspanode, xode, OptODE); % 
            obj.Xk      =	Xspank(end, :)'; 
...
%             lambda  =   x(2);
        ...
        dx(3)	=	2 / tgo * omega + obj.cT / tgo * obj.aT - obj.cM / tgo * aMc;
